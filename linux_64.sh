...
sudo mv /home/pdv/Mercadologic/Compartilhamento/Versao/Instalacao /home/pdv/Mercadologic/

### Atualizar repositorio de arquivos udev
echo "---- Regras Udev ---- "
sudo mv /home/pdv/Mercadologic/Compartilhamento/Versao/Impressoras/udev/20-SAM4S-USB-Printer.rules /etc/udev/rules.d 
sudo mv /home/pdv/Mercadologic/Compartilhamento/Versao/Impressoras/udev/69-bema.rules /etc/udev/rules.d
sudo mv /home/pdv/Mercadologic/Compartilhamento/Versao/Impressoras/udev/69-bema_old.rules /etc/udev/rules.d
sudo mv /home/pdv/Mercadologic/Compartilhamento/Versao/Impressoras/udev/50-persistent-usb.rules /etc/udev/rules.d
...
sudo mv /home/pdv/Versao/50-unity-greeter.conf /usr/share/lightdm/lightdm.conf.d/


#Definindo Compartilhamento
echo "---- Definir configurações do samba ---- "
sudo mv /home/pdv/Versao/smb.conf /etc/samba/
sudo printf "$pw\n$pw\n" | smbpasswd -a pdv
...
sudo cp /home/pdv/Mercadologic/Instalacao/VNC/x11vncrc /home/pdv/.x11vncrc
...
sudo cp /home/pdv/Mercadologic/Instalacao/Configurador/config.desktop /usr/share/applications/
sudo cp /home/pdv/Mercadologic/Instalacao/App/kill-java.desktop /usr/share/applications/
sudo cp /home/pdv/Mercadologic/Instalacao/Balanca-Teste/balanca.desktop /usr/share/applications/
sudo cp /home/pdv/Mercadologic/Instalacao/Executar_PDV/mercadologic.desktop /usr/share/applications/
...
sudo mv /home/pdv/Versao/Impressoras/filter/rastertohprt /usr/lib/cups/filter
sudo chmod 755 /usr/lib/cups/filter/rastertohprt
sudo chown root:root /usr/lib/cups/filter/rastertohprt

sudo mv /home/pdv/Versao/Impressoras/filter/RasterToSPrinter /usr/lib/cups/filter
sudo chmod 755 /usr/lib/cups/filter/RasterToSPrinter
sudo chown root:root /usr/lib/cups/filter/RasterToSPrinter

echo "####### Regras Udev ####### " 

sudo mv /home/pdv/Versao/Impressoras/udev/20-SAM4S-USB-Printer.rules /etc/udev/rules.d 
sudo mv /home/pdv/Versao/Impressoras/udev/69-bema.rules /etc/udev/rules.d
sudo mv /home/pdv/Versao/Impressoras/udev/69-bema_old.rules /etc/udev/rules.d
sudo mv /home/pdv/Versao/Impressoras/udev/50-persistent-usb.rules /etc/udev/rules.d
